...
public class G1 extends Karte{
     ...
     *       id = G135
     *   6 = Flurknoten verbunden über Kanten mit G111, G116, G115, 5
     *       id = G136
     *
     *
     *   Kanten:
    ...
    private void setUp() {
        ...
        Kante g175 = new Kante("G175", g136, g115,2);       //siehe Kante 15, Gewicht = grobe Entfernung in Meter
        Kante g176 = new Kante("G176", g136, g116,2);       //siehe Kante 16, Gewicht = grobe Entfernung in Meter
